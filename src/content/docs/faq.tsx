...
export const faqArticles: DocArticle[] = [
  {
    ...
    categorySlug: "faq",
    title: "General FAQ",
    description: "Common questions about Bheem",
    audience: "both",
    order: 1,
    content: () => (
      <>
        ...
        <h3>Can I use Bheem for free?</h3>
        <p>
          Yes. Bheem is open-source and all features are available without any usage limits. You only need to provide your own Groq API key.
        </p>
        ...
        <p>
          Chrome on desktop is recommended for full voice, video, and interactive tool support. Safari and Firefox generally work but may have limitations. Mobile browsers can run Bheem, though a desktop is recommended for critical interviews.
        </p>
        ...
        <p>
          Bheem saves your progress automatically. Return to the same interview link to resume where you left off. The interviewer can also view any data captured before the disconnection.
        </p>
